      ...
      <div className="min-h-full pb-10 sm:px-10 px-5">
        <div className="max-w-200 mx-auto">
          ...
          <div className="leading-7 text-muted-foreground">
            船橋
            一汰（以下「運営者」といいます。）は、運営者が提供するMutar（以下「本サービス」といいます。）における個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
          </div>

          <Section title="第1条（個人情報の定義）">
            <p>
              本ポリシーにおいて「個人情報」とは、個人情報の保護に関する法律（平成15年法律第57号。以下「個人情報保護法」といいます。）に定める個人情報をいいます。
            </p>
          </Section>
          ...
          <Section title="第5条（個人データの取扱いの委託）">
            <p>
              運営者は、利用目的の達成に必要な範囲で、個人データの取扱いの全部又は一部を第三者に委託することがあります。この場合、運営者は、委託先を適切に選定し、必要かつ適切な監督を行います。
            </p>
          </Section>
          ...
          <Section title="第9条（開示等の請求）">
            <p>
              本人は、個人情報保護法の定めに従い、運営者に対し、保有個人データの利用目的の通知、開示、訂正、追加、削除、利用停止、消去又は第三者提供の停止を請求することができます。
            </p>
            <p>
              開示等の請求を行う場合は、第11条に定めるお問い合わせ窓口までご連絡ください。運営者は、本人確認を行った上で、法令に従い対応します。
            </p>
          </Section>

          <Section title="第10条（本ポリシーの変更）">
            <p>
              運営者は、法令の改正又は本サービスの内容の変更等に応じて、本ポリシーを変更することがあります。変更後の本ポリシーは、本サービス上に掲載した時点から効力を生じます。
            </p>
          </Section>
